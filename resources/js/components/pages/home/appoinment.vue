            ...
            <div class="container py-5">
                <div class="row gx-5">
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        <div class="mb-4">
                            <h3 class="d-inline-block text-primary text-uppercase border-bottom border-5">Appointment
                            </h3>
                            <h1 class="display-4">Make An Appointment For Your Ear Treatment</h1>
                        </div>
                        <p class="text-gray mb-5">Eirmod sed tempor lorem ut dolores. Aliquyam sit sadipscing kasd
                        ...
                        <router-link to="/" class="btn btn-dark rounded-pill py-3 px-5 me-3">Find Doctor</router-link>
                    </div>
                    <div class="col-lg-6">
                        <div class="bg-primary text-center rounded p-5">
                            ...
                            <form>
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <button class="btn btn-dark w-100 py-3" type="submit">Make An
                                            Appointment</button>
                                    </div>
                                </div>
                            </form>
